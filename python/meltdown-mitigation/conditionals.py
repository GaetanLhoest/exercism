...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    reactor_health = temperature * neutrons_produced_per_second
    if reactor_health < (threshold * 9 / 10):
        return "LOW"
    elif threshold - (threshold / 10) < reactor_health < threshold + (threshold / 10):
        return "NORMAL"
    else:
        return "DANGER"
